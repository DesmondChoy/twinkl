...
**always prefer the `ask_user` tool** over guessing or making
assumptions. It presents structured questions (choice, text, or yes/no)
that resolve ambiguity quickly and keep the workflow moving.
