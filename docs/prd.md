...
*Last verified: 2026-08-31; saved Persona integration and North Star Moment evaluation status updated 2026-09-07.*
...
* **Target users / addressable market**
    ...
    * Use five curated personas for the capstone menu, with one recommended walkthrough. Together they cover six Schwartz Core Values, all three current Drift states, and Historical Drift Records that end.
