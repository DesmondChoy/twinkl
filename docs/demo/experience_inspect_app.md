...
This document specifies the capstone demo experience. It is not yet an
implemented product contract. The existing React onboarding implementation and
the [Onboarding Specification](../onboarding/onboarding_spec.md) remain
