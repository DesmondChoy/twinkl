...
| `MIN_ENTRIES` | 3 | Minimum entries per persona |
| `MAX_ENTRIES` | 10 | Maximum entries per persona |
...
- Generate dates for that persona's entry count, starting from `{{START_DATE}}`
...
Example for a persona with 4 entries (randomly selected) starting 2025-12-01:
- Entry 1: 2025-12-01 (START_DATE)
- Gap 1: `random.randint(2, 10)` → e.g., 5 days
- Entry 2: 2025-12-06
- Gap 2: `random.randint(2, 10)` → e.g., 3 days
- Entry 3: 2025-12-09
- Gap 3: `random.randint(2, 10)` → e.g., 7 days
- Entry 4: 2025-12-16
