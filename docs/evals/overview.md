...
| 2 | [`value_modeling_eval.md`](./value_modeling_eval.md) | Model Training | Critic recovers visible conflict evidence | Primary: entry-level `recall_-1`; mandatory precision-recall reporting; QWK and `+1` diagnostic |
| 3 | [`drift_detection_eval.md`](./drift_detection_eval.md) | Inference | Drift triggers detect sustained conflict without unacceptable false alerts | Primary: episode recall; precision / false-alert tolerance deferred until candidate development |
