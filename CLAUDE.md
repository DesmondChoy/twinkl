...
This file mirrors `AGENTS.md` for Claude. Keep their repository policy aligned;
only Claude-specific interface wording should differ.
...
Before an authorized commit, run `/quality` and follow
`.claude/skills/quality/SKILL.md` as the fresh-eyes review checklist.
