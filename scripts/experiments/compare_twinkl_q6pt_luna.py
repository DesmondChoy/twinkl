"""Compare GPT-5.6 and GPT-6 Luna on frozen current Weekly Drift requests.
...
DEFAULT_CONFIG = ROOT / "config/evals/twinkl_q6pt_luna_model_v1.yaml"
FROZEN_CODE = (
    "scripts/experiments/compare_twinkl_q6pt_luna.py",
...
def score(config_path: Path) -> dict[str, Any]:
    ...
    comparisons = {
        ...
        for offset, effort in enumerate(("none", "low"), start=1)
    }
    metrics = {
        "study_id": config["study_id"],
